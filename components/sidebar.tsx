...
type Project = {
  id: string // Changed from project_id: number
  name: string // Changed from title: string
  description: string | null // Match DB type
}
  ...
  useEffect(() => {
    async function fetchProjects() {
      ...
      const { data, error } = await supabase
        .from("projects")
        .select("id, name, description") // Fetch id and name
